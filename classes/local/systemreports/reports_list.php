...
namespace local_ace\local\systemreports;
...
use local_ace\local\entities\activity;
...
class reports_list extends system_report {
    ...
    protected function initialise(): void {
        ...
        $entityactivity = new activity();
        $entityuseralias = $entityactivity->get_table_alias('modules');
        ...
        $this->add_entity($entityuser
             ->add_join("
                            JOIN {user} {$entityuseralias} ON {$entityuseralias}.id = rb.usermodified
