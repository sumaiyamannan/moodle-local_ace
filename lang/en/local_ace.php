...
$string['ace:getpredictions'] = 'Get predictions via web-service';
...
$string['courseacedashboard'] = 'ACE Teach';
...
$string['firstinfamily'] = 'First in Whānau';
...
$string['strftimeexportformat'] = '%A, %d %B %Y, %I:%M %p';
